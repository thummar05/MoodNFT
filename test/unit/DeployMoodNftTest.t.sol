...
contract DeployMoodNftTest is Test{
    ...
    function testConvertToSvgUri() public view{
        ...
        assertEq(keccak256(abi.encodePacked(convertedsvg)) , keccak256(abi.encodePacked(expectedSvg)));
    }
